...
contract AxiomRouterTest is Test {
    ...
    function test_Register() public {
        ...
        bytes32 recordId = axiomFacets.register{value: BASE_FEE}(contentHash1, "ipfs://QmTest123");
    ...
    function test_Register_EmitsEvent() public {
        ...
        emit ContentRegistered(expectedRecordId, user1, contentHash1, uint40(block.timestamp), "ipfs://QmTest123");
    ...
    function test_DisputeContent() public {
        ...
        vm.prank(operator);
        AxiomAccess(address(axiom)).disputeContent(recordId, "Possible deepfake");
    ...
    function test_DisputeContent_RecordNotFound() public {
        ...
        vm.prank(operator);
        vm.expectRevert();
        AxiomAccess(address(axiom)).disputeContent(fakeRecordId, "reason");
    }
